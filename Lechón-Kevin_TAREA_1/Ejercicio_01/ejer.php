...
<body>
    <div class="container mt-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="?opcion=factorial" class="btn btn-success btn-lg btn-block mb-3">1. Calcular Factorial</a>
                <a href="?opcion=primo" class="btn btn-info btn-lg btn-block mb-3">2. Comprobar si es Primo</a>
                <a href="?opcion=serie" class="btn btn-warning btn-lg btn-block mb-3">3. Calcular Serie Matemática</a>
