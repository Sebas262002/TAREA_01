...
<body>
    <div class="container mt-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="?opcion=fibonacci" class="btn btn-success btn-lg btn-block mb-3">1. Serie Fibonacci</a>
                <a href="?opcion=cubo" class="btn btn-info btn-lg btn-block mb-3">2. Números Especiales</a>
                <a href="?opcion=fraccionarios" class="btn btn-warning btn-lg btn-block mb-3">3. Operaciones con Fraccionarios</a>
                <a href="?opcion=salir" class="btn btn-danger btn-block mb-3">Salir</a>
            </div>
        </div>
